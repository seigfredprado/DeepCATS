"""
DeepCATS-AD Script
Deeplearning Counting in Anatomically Targeted Structures for Alzheimer's 
Disease Mouse Models
Author: Seigfred Prado and Gerald Moore
...
1) Run from command line with
    ipython deepcats_ad.py -- <*Ch2_Stitched_Sections> -maskpath <*SEGRES.tif> -hempath <*HEMRES.tif> -radius 10 -ncpu 8 -structures <DORsm,DORpm>
...
if __name__ == '__main__':
    ...
    image_path = '/rds/general/project/thefarm2/live/TissueCyte/5xFAD/Data/y21/y21-Mosaic/Ch3_Stitched_Sections_06_02_2022'
    mask_path = '/rds/general/project/thefarm2/live/TissueCyte/5xFAD/Data/y21/y21-Mosaic/Registration_par00GMaffine.txtpar00GMbspline.txt_2022_02_06/Ch3plusCh2_z-scaled.tifSEGRES.tif'
    hem_path = '/rds/general/project/thefarm2/live/TissueCyte/5xFAD/Data/y21/y21-Mosaic/Registration_par00GMaffine.txtpar00GMbspline.txt_2022_02_06/Ch3plusCh2_z-scaled.tifHEMRES.tif'
    structure_list = 'HPF,TH,HY,CTXsp,STR,Isocortex,OLF,PAL,MB,fiber tracts'
    ncpu = 32
    radius = 20
    size = 200
    ...
    index = np.array([[], [], []])
    if mask:
        anno_file = json.load(open('/rds/general/user/svp15/home/DeepCATS-AD/deepcats/2017_annotation_structure_info.json'))
    ...
    #slack_message = 'Counting in %s completed in %02d:%02d:%02d:%02d' % (image_path.split(os.sep)[-3], days, hours, minutes, seconds)
    
    """
    slack.ACCESS_TOKEN = 'xoxb-1010739164934-1819281582519-jiGUenoTX8OJmpSLtpZkegsd'
    slack.send_notify('stp_pipeline_updates', text = slack_message, username='neurobot')
    print ('')
    print (slack_message)
    """